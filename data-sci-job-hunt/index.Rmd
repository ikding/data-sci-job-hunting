...
subtitle    : 
author      : I-Kang Ding (Data Scientist, Capital One Labs)
job         : Oct 2015
...
* Data Scientist at Capital One Labs
...
**Action**: set up job alerts for targeted geographics and/or companies
...
* Things to know:
    * You often can stick with simpler models (eg. linear or logistic regression).
    ...
    * You must be able to analyze data with code (eg. R, python). I did all my analysis with R / RMarkdown, but Python / iPython notebook will work too. 
...
* Well-thought and well-prepared questions for them will:
    * shows them that you are genuinely interested in the job (and have done your homework) before the interview)
...
Read the Chapman book for more details!

---

## Questions?

Slide is available at: http://ikding.github.io/data-science-job-hunting/
